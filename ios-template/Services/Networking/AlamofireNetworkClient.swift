...
//  ios-template
//
// Optional Alamofire-based Network Client
//

// This implementation requires the Alamofire package.
// To use it:
// 1. Add Alamofire via Swift Package Manager.
// 2. Uncomment this file's contents.
